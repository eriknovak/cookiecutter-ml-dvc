...
# Setup pipeline files from templates
echo "Setting up DVC pipelines..."
python dvc/dvc_init_pipelines.py

echo "DVC setup complete! Use 'dvc repro' to run the pipelines."
